...
if __name__ == '__main__':
    ...
    #############
    deg1 = np.array([6, 7, 4, 8, 10, 30, 9, 3, 90, 15, 5, 7, 45, 12, 30])
    deg2 = np.array([-20, 3, -2, -80, -1, -9, -40, -3, -5, 3, -1, 2, -10, -20, -10])
    for i in range(15):
        # Turn left to a yaw angle of 5 degrees:
        client.move(0.0, 0.0, 0.45, deg1[i], 0.5)
        # Turn right to a yaw angle of -5 degrees:
        client.move(0.0, 0.0, 0.45, deg2[i], 0.5)
        # Return to hover at a yaw angle of 0 degrees:
        client.move(0.0, 0.0, 0.45, 0.0, 0.5)
        print('iteration: ', i)
    ...
    client.write_data('moment_data.json')
